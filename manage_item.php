...
if (isset($_POST['game_id']) && isset($_POST['gambar_resource']) && isset($_POST['nominal_resource']) && isset($_POST['harga_satuan'])) {
...
<body class="bg-dark">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container" style="padding: 160px 0 20px 0;">
                    <div class="card border-black text-white mb-4 animate"  style='border-radius: 1rem;background-color: rgb(0, 0, 0, 0.6) !important'>
    ...
    <div class="modal fade" id="addItemModal" tabindex="-1" role="dialog" aria-labelledby="addAdminModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <h5 class="modal-title" id="addAdminModalLabel">Tambah Item</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form name="add_game" action="manage_item.php" method="post" class="m-3"
                        ...
                        <div class="form-group  mb-3">
                            <h4>Path Gambar Resource</h4><input type="textarea" class="form-control mt-1"
                                placeholder="" name="gambar_resource">
                        </div>
                        <div class="form-group  mb-3">
                            <h4>Nominal Resource</h4><input type="textarea" class="form-control mt-1" placeholder="Nominal Resource"
                                name="nominal_resource">
                        </div>
                        <div class="form-group  mb-3">
                            <h4>Harga</h4><input type="textarea" class="form-control mt-1"
                                placeholder="Harga" name="harga_satuan">
                        </div>
