    ...
    <nav class="py-4 navbar navbar-expand-lg navbar-dark fixed-top"
        ...
        <div class="container px-4 px-lg-5 text-white">
            <a class="navbar-brand" style="height: 52px;" href="admin.php">
                <img src="assets\Web Logo\pay-2-win-full.png" alt="PAY2WIN Logo" class="img-fluid" style="max-height: 50px;margin-top: -2px;height: 100%;object-fit: cover;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-center me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item me-lg-4 d-lg-block"><a class="nav-link active" aria-current="page" href="admin.php">HOME</a>
                    </li>
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class='card animate text-white mb-3 h-100 d-flex align-items-center'
                        style='border-radius: 1rem; background-color: rgba(10, 10, 12, 0.6) !important'>
                ...
                <div class="col mb-5">
                    <div class='card animate text-white mb-3 h-100 d-flex align-items-center'style='border-radius: 1rem; background-color: rgba(10, 10, 12, 0.6) !important'>
                        <div class='card-body p-4'>
                            <div class='text-center'>
